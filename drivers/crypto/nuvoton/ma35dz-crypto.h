 ...
 *
 */
#ifndef __MA35DZ_CRYPTO_H__
#define __MA35DZ_CRYPTO_H__
...
extern int ma35dz_prng_probe(struct device *dev, void __iomem *reg_base, unsigned long *data);
extern int ma35dz_prng_remove(struct device *dev, unsigned long data);

extern int ma35dz_aes_probe(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);
extern int ma35dz_aes_remove(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);

extern int ma35dz_sha_probe(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);
extern int ma35dz_sha_remove(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);

extern int ma35dz_ecc_probe(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);
extern int ma35dz_ecc_remove(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);

extern int ma35dz_rsa_probe(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);
extern int ma35dz_rsa_remove(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);
