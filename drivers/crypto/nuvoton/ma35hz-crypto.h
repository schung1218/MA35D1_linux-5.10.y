 ...
 *
 */
#ifndef __MA35HZ_CRYPTO_H__
#define __MA35HZ_CRYPTO_H__
...
extern int ma35hz_prng_probe(struct device *dev, void __iomem *reg_base, unsigned long *data);
extern int ma35hz_prng_remove(struct device *dev, unsigned long data);

extern int ma35hz_aes_probe(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);
extern int ma35hz_aes_remove(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);

extern int ma35hz_sha_probe(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);
extern int ma35hz_sha_remove(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);

extern int ma35hz_ecc_probe(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);
extern int ma35hz_ecc_remove(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);

extern int ma35hz_rsa_probe(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);
extern int ma35hz_rsa_remove(struct device *dev, struct nu_crypto_dev *nu_cryp_dev);
