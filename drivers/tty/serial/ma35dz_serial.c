...
/*
 *  MA35DZ serial driver
 *
 *  Copyright (C) 2018 Nuvoton Technology Corp.
 *
 */

#if defined(CONFIG_SERIAL_MA35DZ_CONSOLE) && defined(CONFIG_MAGIC_SYSRQ)
...
static const struct of_device_id ma35_serial_of_match[] = {
	{ .compatible = "nuvoton,ma35dz-uart" },
	{},
};
...
static void __init ma35serial_init_ports(void)
{
	...
	for_each_matching_node(np, ma35_serial_of_match) {
		...
		if (!of_find_property(np, "ma35dz-console", NULL))
				continue;
...
#if defined(CONFIG_SERIAL_MA35DZ_CONSOLE)
